...
//        연산자의 우선 순위 때문에 왼쪽부터 차례대로 연산을 진행하여 문자열과 숫자(65000)의 연산이 먼저 발생하고, 그 이후에 문자열과 두번째 숫자(2000)과의 연산이 발생하여
//        '로세티리 바베큐 세트 65002000원' 이라는 형태로 화면에 출력 됨
