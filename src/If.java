...
//        마지막에 존재하는 else문은 생략 가능함 (else 구문으로 갈 수 없도록 모든 조건을 다 입력했을 경우, else문으로 빠지는 경우에 아무런 처리를 하지 않을때)
...
//        중첩 if문 : if, if ~ else, else if 문의 코드블럭에 if문을 사용하는 방식
        ...
        if (grade1 >= 90){
            System.out.println("당신의 점수는 " + grade1 + "점이고, 당신의 등급은 A 입니다.");
        }
        else {
            if (grade1 >= 80){
                System.out.println("당신의 점수는 " + grade1 + "점이고, 당신의 등급은 B 입니다.");
            }
            else{
                if (grade1 >= 70){
                    System.out.println("당신의 점수는 " + grade1 + "점이고, 당신의 등급은 C 입니다.");
                }
                else{
                    if (grade1 >= 60){
                        System.out.println("당신의 점수는 " + grade1 + "점이고, 당신의 등급은 D 입니다.");
                    }
                    else{
                        System.out.println("당신의 점수는 " + grade1 + "점이고, 당신의 등급은 F 입니다.");
                    }
                }
            }
        }
